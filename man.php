                ...
                <div class="col-md-3">
                    ...
                    <div class="row d-flex justify-content-center mt-3">
                        <div class="col-md-5" style="padding: 0; margin: 0;">
                            <button class="joinus btn mt-3 text-white" style="background-color:#77afd4; font-size: 18px; margin: 0;">Join Us</button>
                        </div>
                    </div>
                </div>

                <div class="col-md-5 offset-md-4">
                    <svg class="home-svg text-center" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="fill: #77afd4; width:520px; margin-top: 70px;">
                        ...
                        <g mask="url(#mask0)">
                            ...
                            <image class="home-img" x="-40" y="-18" href="icon/Man_Banner.png" style="width: 260px;" />
                        </g>
                    </svg>
                </div>
            </div>
        ...
        <div class="container" style="border: none;">
            <div class="product mt-5">
                <div class="row justify-content-between" style="text-align:center;">
                    ...
                    $sql = "select * from produk where kategori='man' ";
