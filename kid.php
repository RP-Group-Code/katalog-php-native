            ...
            <div class="row justify-content-between">
                <div class="col-md-3">
                    <div class="title-jumbotron pt-2">
                        <h1 style="font-family: 'Caveat', cursive; padding-top: 120px;">Clotch <b style="color: #ff69e4;"> Store </b></h1>
                        <p class="lead"> <b style="color: #ff78d2;">Clotch Store </b> <b> Palembang </b> <b style="color: #ff69e4;"> RPGroup </b> </p>
                    </div>
                    ...
                    <div class="row d-flex justify-content-center mt-3">
                        <div class="col-md-5" style="padding: 0; margin: 0;">
                            <button class="joinus btn mt-3 text-white" style="background-color: #ff69e4; font-size: 18px; margin: 0;">Join Us</button>
                        </div>
                    </div>
                </div>

                <div class="col-md-5 offset-md-4">
                    <svg class="home-svg text-center" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="fill: #ff69e4; width:520px; margin-top: 70px;">
                        ...
                        <g mask="url(#mask0)">
                            ...
                            <image class="home-img" x="10" y="-25" href="icon/Kid_Banner.png" style="width: 180px;" />
                        </g>
                    </svg>
                </div>
            </div>
        ...
        <div class="container" style="border: none;">
            <div class="product mt-5">
                <div class="row justify-content-between" style="text-align:center;">
                    ...
                    $sql = "select * from produk where kategori='kid' ";
