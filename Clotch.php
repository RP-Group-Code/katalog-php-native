                ...
                <div class="col-md-3">
                    ...
                    <div class="row d-flex justify-content-center mt-3">
                        <div class="col-md-5" style="padding: 0; margin: 0;">
                            <button class="joinus btn mt-3" style="background-color:blanchedalmond; font-size: 18px; margin: 0;"><b>Join Us</b> </button>
                        </div>
                    </div>
                </div>

                <div class="col-md-5 offset-md-4">
                    <img class="mt-5" style="z-index: 2; position: relative; transform:rotate(25deg);" src="gambar_product/Shoes-Orange.png" width="505" height="505" alt="">
                    <div class="elips" style="position: absolute; margin-top: -480px; z-index: 1;">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="456" height="456" viewBox="0 0 536 536">
                            <defs>
                                <linearGradient id="linear-gradient" x1="0.839" y1="0.195" x2="0.104" y2="0.789" gradientUnits="objectBoundingBox">
                                    <stop offset="0" stop-color="#f6cb1f" />
                                    <stop offset="0.625" stop-color="#924619" />
        ...
        <div class="content mt-5">
            <div class="header-catalog">
                <div class="row justify-content-center">
                    <div class="col-md-2 align-self-centera">
                                ...
                                <div class="row">
                                    <div class="gambar" style="min-height: 550px;">
                                        <a href="show-katalog.php?id=<?php echo $row['id'] ?>">
                                            <img class="gambarproduct" src="<?php echo $upload_dir . $row['image'] ?>" style="max-width: 100%; cursor: pointer;">
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="footer-info">
                        <div class="row justify-content-between" style="padding-top: 120px;">
                            ...
                            <div class="col-md-2 offset-md">
                                <div class="row">
                                    <a href="https://rulipocket.000webhostapp.com/">
